...
class UnlockEventAwardsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Grpc\Build\Admin\UnlockEventAwardsRequest\Operator $operator
     *     @type \Grpc\Build\Admin\UnlockEventAwardsRequest\Member $member
    ...
    /**
     * Generated from protobuf field <code>.admin.UnlockEventAwardsRequest.Operator operator = 1;</code>
     * @return \Grpc\Build\Admin\UnlockEventAwardsRequest\Operator|null
     */
    ...
    /**
     * Generated from protobuf field <code>.admin.UnlockEventAwardsRequest.Operator operator = 1;</code>
     * @param \Grpc\Build\Admin\UnlockEventAwardsRequest\Operator $var
     * @return $this
     */
    public function setOperator($var)
    {
        GPBUtil::checkMessage($var, \Grpc\Build\Admin\UnlockEventAwardsRequest\Operator::class);
        $this->operator = $var;
    ...
    /**
     * Generated from protobuf field <code>.admin.UnlockEventAwardsRequest.Member member = 2;</code>
     * @return \Grpc\Build\Admin\UnlockEventAwardsRequest\Member|null
     */
    ...
    /**
     * Generated from protobuf field <code>.admin.UnlockEventAwardsRequest.Member member = 2;</code>
     * @param \Grpc\Build\Admin\UnlockEventAwardsRequest\Member $var
     * @return $this
     */
    public function setMember($var)
    {
        GPBUtil::checkMessage($var, \Grpc\Build\Admin\UnlockEventAwardsRequest\Member::class);
        $this->member = $var;
